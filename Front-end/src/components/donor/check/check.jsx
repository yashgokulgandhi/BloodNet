  ...
  function BloodDonationForm() {
    ...
    const onSubmit = (data) => {
      console.log(data)
      // Here you would implement the logic to check eligibility
    ...
    const formFields = [
      ...
      {
        name: "recentIllness",
        label: "Has the donor had any infections, colds, flu, or fever in the past 1–2 weeks?",
        type: "radio",
      },
      {
        name: "chronicConditions",
        label: "Does the donor have any chronic illnesses like diabetes, heart disease, or cancer?",
        type: "radio",
      },
      {
        name: "infectiousDiseases",
        label: "Has the donor ever tested positive for HIV, hepatitis B or C, syphilis, or other transmissible diseases?",
        type: "radio",
      },
      {
        name: "recentSurgery",
        label: "Has the donor undergone surgery or received a blood transfusion in the past 6–12 months?",
        type: "radio",
      },
      {
        name: "pregnancy",
        label: "Is the donor pregnant or recently given birth (within the last 6 weeks)?",
        type: "radio",
      },
      { name: "medications", label: "Is the donor taking any medications that might affect eligibility?", type: "radio" },
      {
        name: "travelHistory",
        label: "Has the donor traveled to regions with endemic diseases in the past 3–12 months?",
        type: "radio",
      },
      {
        name: "exposureToInfections",
        label: "Has the donor been in close contact with someone who has an infectious disease?",
        type: "radio",
      },
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-100 to-red-200 p-8">
        ...
        >
          ...
          >Let's check your eligibility to be a lifesaver!</motion.p>
        </motion.header>
